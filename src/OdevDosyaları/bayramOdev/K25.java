    ...
    1.    Frankfurt veya Köln olarak bir giriş yapın. (Girdiğiniz sehrin harfleri , girildikten sonra büyük hale gelsin.
      ...
      "Rota = Köln" yazdırın.
       ...
       case:1  ise
        ...
        System.out.println("lutfen seyahat edeceginiz yeri seciniz\nkoln mu?\nfrankurt mu?");
        String yer=scan.next();
        yer=yer.toLowerCase();
        System.out.println("gideceginiz yer kac km?");
       int yol=scan.nextInt();
        System.out.println("kac kisi yolculuk edecek max:2 kisi olabilir");
        int kisi=scan.nextInt();
 if (kisi==1) {
     switch (yer) {
         case "koln":
             System.out.println("Rota = KOLN");
             System.out.println("KOLN " + ((yol / 20) * 5) + " euro");
             break;
         case "frankurt":
             System.out.println("Rota =FRANKURT");
             System.out.println("FRANKURT " + ((yol / 20) * 5) + " euro");
             break;
     ...
     switch (yer) {
         case "koln":
             System.out.println("Rota = KOLN");
             System.out.println("KOLN-2 kisilik " + ((yol / 20) * 5)*2 + " euro");
             break;
         case "frankurt":
             System.out.println("Rota =FRANKURT");
             System.out.println("FRANKURT-2 kisilik " + ((yol / 20) * 5)*2 + " euro");
             break;
